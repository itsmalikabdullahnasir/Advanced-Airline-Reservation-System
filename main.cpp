...
std::list<Staff> staffList; // Global list of Staff
std::list<Inventory> inventoryList; // Global list of Inventory
...
void  Menu::select(int selection){
    ...
    switch(selection){
        ...
        case 8: {
            ...
            int selection = atoi(temp.c_str());
                ...
                case 1: {
                    ...
                    cin >> temp;
                    while (!checkNumber(temp)) {
                        cout << "Staff ID must be a number!" << endl;
                        cin.clear();
                        cin.ignore(256, '\n');
                        cin >> temp;
                    }
                    ...
                    Staff staff(id, name, position, address, contactNumber);
                    staffList.push_back(staff);
                    break;
                }
                case 2: {
                    for (std::list<Staff>::iterator i = staffList.begin(); i != staffList.end(); ++i) {
                        cout << "Staff ID: " << i->getId() << endl;
                        cout << "Staff Name: " << i->getName() << endl;
                        cout << "Staff Position: " << i->getPosition() << endl;
                        cout << "Staff Address: " << i->getAddress() << endl;
                        cout << "Staff Contact Number: " << i->getContactNumber() << endl;
                    }
                    break;
                }
                case 3: {
                    ...
                    for (std::list<Staff>::iterator i = staffList.begin(); i != staffList.end(); ++i) {
                        if (id == i->getId()) {
                            i = staffList.erase(i);
                            cout << "Staff with ID: " << id << " was successfully deleted" << endl;
                            break;
                        }
                    }
                    break;
        ...
        case 9:
            ...
            cout << "4. Delete Inventory\n";
            cout << "5. Exit\n";
            cout << "Enter your choice: ";
            cin >> inventorySelection;

            switch(inventorySelection) {
                case 1: {
                    // Add Inventory
                    // Ask the user for the inventory details
                    // Create an inventory object and add it to your inventory list
                    std::string aircraft;
                    int seatingAvailability;
                    std::string cateringServices;
                    cout << "Enter Aircraft: ";
                    cin >> aircraft;
                    cout << "Enter Seating Availability: ";
                    cin >> seatingAvailability;
                    cout << "Enter Catering Services: ";
                    cin >> cateringServices;
                    Inventory inventory(aircraft, seatingAvailability, cateringServices);
                ...
                case 2: {
                    // Display Inventory
                    // Display all the inventory details
                    for (std::list<Inventory>::iterator i = inventoryList.begin(); i != inventoryList.end(); ++i) {
                        cout << "Aircraft: " << i->getAircraft() << endl;
                        cout << "Seating Availability: " << i->getSeatingAvailability() << endl;
                        cout << "Catering Services: " << i->getCateringServices() << endl;
                    }
                    break;
                }
                case 3: {
                    // Update Inventory
                    // Ask the user for the inventory to be updated
                    // Find the inventory in your inventory list and update it
                    std::string aircraft;
                    cout << "Enter Aircraft to update: ";
                    cin >> aircraft;
                    for (std::list<Inventory>::iterator i = inventoryList.begin(); i != inventoryList.end(); ++i) {
                        if (i->getAircraft() == aircraft) {
                            std::string newAircraft;
                            int newSeatingAvailability;
                            std::string newCateringServices;
                            cout << "Enter new Aircraft: ";
                            cin >> newAircraft;
                            cout << "Enter new Seating Availability: ";
                            cin >> newSeatingAvailability;
                            cout << "Enter new Catering Services: ";
                            cin >> newCateringServices;
                            i->setAircraft(newAircraft);
                            i->setSeatingAvailability(newSeatingAvailability);
                            i->setCateringServices(newCateringServices);
                ...
                case 4: {
                    // Delete Inventory
                    // Ask the user for the inventory to be deleted
                    // Find the inventory in your inventory list and delete it
                    std::string aircraft;
                    cout << "Enter Aircraft to delete: ";
                    cin >> aircraft;
                    for (std::list<Inventory>::iterator i = inventoryList.begin(); i != inventoryList.end(); ++i) {
                        if (i->getAircraft() == aircraft) {
                            i = inventoryList.erase(i);
        ...
        case 10:
            ...
            cout << "2. Generate Passenger Demographics Report\n";
            cout << "3. Generate Flight Performance Report\n";
            cout << "4. Generate Staff Productivity Report\n";
            cout << "5. Exit\n";
            cout << "Enter your choice: ";
            cin >> reportSelection;
            ...
            switch(reportSelection) {
                ...
                case 2: {
                    // Generate Passenger Demographics Report
                    report.generatePassengerDemographicsReport();
                    break;
                }
                case 3: {
                    // Generate Flight Performance Report
                    report.generateFlightPerformanceReport();
                    break;
                }
                case 4: {
                    // Generate Staff Productivity Report
                    report.generateStaffProductivityReport();
                    break;
                }
                case 5:
                    // Exit
...
int main(){
    User user;
    //user.writeCredentials("admin", "root");
    if (!user.readCredentials()) {
        std::cerr << "Failed to read credentials from file.\n";
        return 1;
    }
    ...
    do {
        ...
        if (!loginSuccessful) {
            ...
            std::cerr << "Invalid username or password. Please try again.\n";
        }
